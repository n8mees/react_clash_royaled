...
export default function WinScreen({ chosenCard, onReset, onClose }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div
        className="relative w-full max-w-2xl mx-auto bg-gradient-to-br from-blue-200 via-purple-100 to-yellow-100 rounded-3xl shadow-2xl p-8 text-center"
